...
```shell
oc new-app routecreation-request-template -p TOOL_NAMESPACE=certificate-tool -p SERVICENAME=httpd -p PORT=8080 -p ROUTENAME=myhttp -p TARGET_NAMESPACE=example-ns -p HOSTNAME=myhttpd.example.com
```
# TODO
